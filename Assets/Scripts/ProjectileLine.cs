...
public class ProjectileLine : MonoBehaviour {
	...
	public
	bool _____________________________;
	...
	public void AddPoint() {
		...
		//if ( points.Count > 0 && (pt - lastPoint).magnitude) (this is because of && error - <3 Alex) // If the point isn't far enough from the last point, it returns
			//return;
		if ( points.Count == 0 ) {
